...
install: options protonvpn-applet
	...
	cp -f protonvpn-applet.desktop /usr/share/applications
	chmod 644 /usr/share/applications/protonvpn-applet.desktop 
...
uninstall:
	...
	rm -f /usr/share/applications/protonvpn-applet.desktop 
